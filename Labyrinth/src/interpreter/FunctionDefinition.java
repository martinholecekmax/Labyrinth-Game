...
class FunctionDefinition implements Comparable<Object>, Serializable {
	...
	/**
	 * Get the depth of this definition. 0 - root or main scope 1 - definition
	 * inside root or main scope 2 - definition inside 1 n - etc.
	 */
	int getLevel() {
		return depth;
	}
	...
	/**
	 * Get the storage slot number of a given variable or parm. Return -1 if it
	 * doesn't exist.
	 */
